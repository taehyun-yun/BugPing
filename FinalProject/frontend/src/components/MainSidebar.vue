<template>
  <div class="side-menu">
    ...
    <div class="menu-item" @click="goPage('contract')" v-if="forEmployer">
      ...
      <!-- <img src="../assets/SidebarImg/contract.svg" alt="Contract Icon" class="icon" /> -->
      <div class="menu-title">계약 관리</div>
    </div>
    <div class="menu-item" @click="goPage('schedule')">
