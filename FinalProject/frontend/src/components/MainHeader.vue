    ...
    <div class="header">
      <div class="header-left">
        <div class="header-icons">
          <img
            src="/src/assets/MainheaderImg/bars-solid.svg"
            class="icon"
            @click="sidebar"
          />
      ...
      <div class="header-right">
        <div class="search-fieldset">
          ...
          <select v-model="selectedCompany">
            ...
            <option
              v-for="company in userStore.companies"
              :key="company.id"
              :value="company"
            >
              {{ company.cname }}
        ...
        <div class="header-icons">
          ...
          <div class="column">
            <img
              src="../assets/MainheaderImg/circle-user-solid.svg"
              alt="profile Icon"
              class="icon"
            />
            <div class="row">
              <div class="row-elem" @click="showModalChange">
                <img
                  src="../assets/MainheaderImg/gear-solid.svg"
                  alt="Gear Icon"
                  class="icon"
                />
                마이페이지
              ...
              <div class="row-elem" @click="goToLoginPage">
                <img
                  src="../assets/MainheaderImg/right-from-bracket-solid.svg"
                  alt="Logout Icon"
                  class="icon"
                />
                로그아웃
        ...
        <div class="item" v-if="!registered">
          <form ref="emailForm">
            ...
            <button class="send-button" @click="sendCode" type="button">
              <img
                ...
                src="/src/assets/Loginimg/Dual Ring.svg"
              />
          ...
          <div class="input-group">
            <input
              ...
              v-model="inputCode"
            />
            <button class="send-button" @click="checkCode" type="button">
              확인
            </button>
          </div>
        </div>
...
const setNewPassword = () => {
  if (pwForm.value.reportValidity()) {
    axios.post(
      `${axiosAddress}/setNewPassword`,
      { userId: userStore.userId, newPassword: newPassword.value },
      { withCredentials: true }
    );
  }
};
...
const checkCode = async () => {
  try {
    ...
    if (res.data) {
      ...
      const setEmailRes = await axios.post(
        axiosAddress + "/setEmail",
        {
