...
public class EmploymentController {
    ...
    public ResponseEntity<Contract> updateContract(@PathVariable Integer id, @RequestBody Contract contractDetails) {
        ...
        if (optionalContract.isPresent()) {
            ...
            contract.setWorkId(contractDetails.getWorkId());
            ...
            contract.setUserId(contractDetails.getUserId());
    ...
    public ResponseEntity<Schedule> updateSchedule(@PathVariable Integer id, @RequestBody Schedule scheduleDetails) {
        ...
        if (optionalSchedule.isPresent()) {
            ...
            schedule.setContractId(scheduleDetails.getContractId());
            ...
            schedule.setBreakHour(scheduleDetails.getBreakHour());
            schedule.setWorkHour(scheduleDetails.getWorkHour());
